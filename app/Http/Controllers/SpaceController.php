...
class SpaceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('space.index')->with('status', 'Data Berhasil Ditambah!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('space.index')->with('status', 'Data Berhasil Diperbaharui');
    }
    ...
    public function destroy($id)
    {
        ...
        $space->delete();
        return redirect()->route('space.index')->with('status', 'Data Berhasil Dihapus');
    }
}